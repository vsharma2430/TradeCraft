...
def get_history_context(STK:str,
        ...
        return {
                ...
                'volume_30':get_comma_format(get_round(get_data_from_dict(history_data,'volume_30'))),
                'volume_90':get_comma_format(get_round(get_data_from_dict(history_data,'volume_90'))),
